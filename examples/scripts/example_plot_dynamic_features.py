...
if __name__ == "__main__":
    ...
    feature = feature_sample.azimuth(in_air=in_air, statistics=statistics)
    # feature = feature_sample.tilt(in_air=in_air, statistics=statistics)
    # feature = feature_sample.pressure(statistics=statistics)
